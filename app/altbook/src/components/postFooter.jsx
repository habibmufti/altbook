  ...
  return (
    <View style={styles.postFotterContainer}>
      ...
      <View style={styles.userActionSec}>
        <View style={styles.row}>
          <VectorIcon name="like2" type="AntDesign" size={25} color={Colors.grey} />
          <Text style={styles.reactionCount}>Like</Text>
        </View>
        <View style={styles.row}>
          <VectorIcon name="chatbox-outline" type="Ionicons" size={25} color={Colors.grey} />
          <Text style={styles.reactionCount}>Comment</Text>
        </View>

        <View style={styles.row}>
          <VectorIcon name="arrow-redo-outline" type="Ionicons" size={25} color={Colors.grey} />
...
const styles = StyleSheet.create({
  ...
  postFotterContainer: {
    padding: 16,
    borderBottomWidth: 8,
    borderBlockColor: Colors.borderGrey
  },
  reactionCount: {
    color: Colors.grey,
    fontSize: 14,
